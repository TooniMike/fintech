      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              isFirstPage ? 'Transfer That is Safe' : 'Transfer Money With Ease',
              style: TextStyle(
            ...
            Text(
              isFirstPage ? 'You have nothing to be scared about, we got you covered.' : 'Making money is hard enough, we make transferring it easy enough.',
              style: TextStyle(
                  color: isFirstPage ? Colors.white : const Color(0xFF17288E),
                  fontSize: 15.sp),
            ),
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: isFirstPage ? Colors.white : const Color(0xFF1C265C)),
                child: Center(
                    child: Text(
                  'Start banking',
                  style: TextStyle(
